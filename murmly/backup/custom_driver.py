...
class NoSignalSshDriver(Driver):
    ...
    def __init__(self, app: "App", **kwargs):
        ...
        self.context: Optional[ParamikoContext] = None
        self._parser: Optional[XTermParser] = None
        self._decode = None
    ...
    def stop(self) -> None:
        ...
        if not self._exit_event.is_set():
            ...
            try:  # Add try/except just in case super().stop() fails
                ...
                log.info(f"--- NoSignalSshDriver: Error calling super().stop(): {e}")
